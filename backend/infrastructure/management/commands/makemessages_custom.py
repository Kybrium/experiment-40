...
class Command(BaseCommand):
    help = "Run makemessages but skip everything except selected folders (default: accounts, minecraft)."

    def add_arguments(self, parser):
        parser.add_argument("-l", "--locale", default="uk", help="Language code (default: uk)")
        parser.add_argument("--folders", nargs="+", default=["accounts", "minecraft"], help="List of folders to include in extraction")
